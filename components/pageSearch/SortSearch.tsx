...
<div className="mt-6 rounded-xl border border-amber-500/20 bg-amber-500/5 p-4">
  <p className="font-medium text-amber-300">
    ⚠️ Ограничения TMDB API
  </p>

  <p className="mt-2 text-sm leading-6 text-gray-400">
    TMDB предоставляет ограниченные возможности для поиска и сортировки
    контента. Большинство расширенных фильтров (жанры, год выпуска и другие
    параметры) недоступны напрямую через API поиска и частично обрабатываются
    на стороне клиента. Также API предлагает ограниченный набор вариантов
    сортировки результатов, поэтому выдача может отличаться от ожидаемой при
    использовании сложных поисковых запросов.
  </p>
</div>
    </div>
  );
